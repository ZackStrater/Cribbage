        ...
        def discard_ai_advanced():  # add scoring from aces and 5's
            ...
            for seq in itertools.combinations(self.hand, 4):
                ...
                for c in deck_minus_hand:
                    cprint("potential cut: ", "yellow", end="")
                    cprint(c.description, "yellow")
                    if self.active:
                    ...
                    for e in seq:
                        if e.run_value == 1:
                            potential_value += 1
                    cprint("value: ", "red", end="")
                    cprint(potential_value, "red")
...
if player_1_type == "easy computer":
    player_1 = Player("Easy Computer 1", deck1, 0, crib1, 1, None)
...
if player_1_type == "expert computer":
    player_1 = Player("Expert Computer 1", deck1, 0, crib1, 3, None)
...
if player_2_type == "easy computer":
    player_2 = Player("Easy Computer 2", deck1, 0, crib1, 1, None)
if player_2_type == "intermediate computer":
    player_2 = Player("Intermediate Computer 2", deck1, 0, crib1, 2, None)
...
# if other player has passed (i.e "go") and other player plays last card, don't need to check again.  (maybe just cancel the extra "go's")?

# AI

# program abbreviated inputs -> 3 would work for 3 of hearts
# if multiple 3's, ask to specify
